...
import { OnlineCardsTab } from './components/OnlineCardsTab';
...
function AdminDashboardContent() {
  ...
  const [activeTab, setActiveTab] = useState<'users' | 'cards' | 'logs' | 'lms' | 'online' | 'settings' | 'devices'>('users');
  ...
  const tabs = [
    ...
    { id: 'online' as const, label: 'Online Cards', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {activeTab === 'online' && <OnlineCardsTab />}
      ...
      {/* Edit User Modal */}
      {
        editingUser && (
          <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center p-0 sm:p-4 z-50">
            <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-w-md w-full flex flex-col max-h-[90dvh]">
